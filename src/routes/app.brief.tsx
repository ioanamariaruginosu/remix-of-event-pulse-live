...
export const Route = createFileRoute("/app/brief")({
  head: () => ({ meta: [{ title: "Session brief — Eurhack 2026" }] }),
  component: Brief,
});
  ...
  return (
    <div className="px-5 pt-6 space-y-5 pb-10">
      <div className="p-4 rounded-2xl bg-accent">
        <div className="text-[9px] font-mono font-bold uppercase tracking-widest mb-1">What you missed</div>
      ...
      <div>
        <div className="text-[10px] font-mono text-foreground/40 uppercase tracking-widest mb-2">Takeaways</div>
        <ol className="space-y-3">
          {sessionBrief.takeaways.map((t, i) => (
            <li key={i} className="flex gap-3">
              <div className="size-6 rounded-full bg-primary text-white grid place-items-center font-mono text-[10px] font-bold shrink-0">{i + 1}</div>
      ...
      <div>
        <div className="text-[10px] font-mono text-foreground/40 uppercase tracking-widest mb-2">Open questions</div>
      ...
      <div>
        <div className="text-[10px] font-mono text-foreground/40 uppercase tracking-widest mb-2">People to follow up with</div>
        <div className="space-y-2">
