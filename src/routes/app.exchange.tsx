...
function Exchange() {
  ...
  return (
    <div className="px-5 pt-6 space-y-5 pb-10">
      <div>
        <div className="text-[10px] font-mono text-primary font-bold uppercase tracking-widest">BLE active</div>
        ...
        {stage === "ready" && (
          ...
          >
            <div className="aspect-square bg-foreground rounded-3xl relative overflow-hidden grid place-items-center">
              ...
              <div className="size-24 bg-primary rounded-full grid place-items-center text-white font-mono text-xs font-bold uppercase tracking-widest shadow-2xl shadow-primary/40">
                Tap
              </div>
            </div>
            <button
        ...
        {stage === "matching" && (
          <motion.div key="matching" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="aspect-square grid place-items-center">
            <div className="text-center space-y-4">
              ...
              <div className="font-mono text-xs uppercase tracking-widest text-foreground/60">Exchanging…</div>
            </div>
          </motion.div>
        )}
        ...
        {stage === "done" && (
          <motion.div key="done" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
            <div className="p-4 rounded-2xl bg-primary-soft ring-1 ring-primary/20">
              <div className="text-[9px] font-mono text-primary font-bold uppercase tracking-widest mb-1">Match earned · +50 XP</div>
